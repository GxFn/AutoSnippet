...
router.get('/', asyncHandler(async (req, res) => {
  const { status, category, language, knowledgeType, kind, keyword } = req.query;
...
router.post('/', asyncHandler(async (req, res) => {
  const {
    ...
    sourceCandidate, tags, dimensions,
 ...
 * AI 批量发现知识图谱关系（通过 ChatAgent discover_all_relations 任务）
