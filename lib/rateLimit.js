...
function checkRecipeSave(projectRoot, clientId, options = {}) {
	...
	const limit = options.limit ?? (Number(process.env.ASD_RECIPE_SAVE_RATE_LIMIT) || DEFAULT_LIMIT);
	const windowSec = options.windowSeconds ?? (Number(process.env.ASD_RECIPE_SAVE_RATE_WINDOW_SECONDS) || DEFAULT_WINDOW_SECONDS);
