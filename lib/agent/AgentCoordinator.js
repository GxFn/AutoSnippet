...
class AgentCoordinator extends EventEmitter {
  ...
  async classifyIntent(userInput, context) {
    ...
    const intentPatterns = {
      ...
      structure: {
        keywords: ['dependency', 'dependencies', 'target', 'targets', 'spm', 'module', 'graph', '依赖', '模块', '结构', 'target'],
        patterns: /\b(dependency|dependencies|target|targets|spm|module|graph|依赖|模块|结构|target)\b/i,
        confidence: 0.82
      },
      generate: {
