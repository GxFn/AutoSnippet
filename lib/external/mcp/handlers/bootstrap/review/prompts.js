...
Each candidate follows a 3-layer structure:
1. **写法** (Pattern) — variant description & statistics
2. **基本使用** (Basic Usage) — minimal, pure code demonstrating just this one technique
3. **项目示例** (Project Examples) — trimmed real project code showing ONLY pattern-relevant lines

When refining, keep this layering in mind. agentNotes should reference the concrete pattern, not generic advice.
