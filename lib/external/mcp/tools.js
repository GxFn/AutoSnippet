  ...
  // 31. 冷启动知识库初始化（自动创建 9 维度 Candidate）
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        autoEnrich: { type: 'boolean', default: true, description: '自动 AI 补齐候选语义字段（Phase 6）。需要 AI Provider 已配置。' },
        autoRefine: { type: 'boolean', default: true, description: '自动 AI 润色候选内容（Phase 7）。需要 AI Provider 已配置。' },
