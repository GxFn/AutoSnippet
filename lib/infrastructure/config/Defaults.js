...
// ─── 路径 ───────────────────────────────────────────────────────────────
const SPEC_FILENAME = 'AutoSnippet.boxspec.json'; // 开发环境唯一 spec，位于知识库目录内
const KNOWLEDGE_BASE_DIR = 'AutoSnippet';
const RECIPES_DIR = 'AutoSnippet/recipes';
const RECIPES_INDEX = 'AutoSnippet/recipes/index.json';
const SPMMAP_FILENAME = 'AutoSnippet.spmmap.json';
const SPMMAP_PATH = `AutoSnippet/${SPMMAP_FILENAME}`;

// ─── Context 存储 ───────────────────────────────────────────────────────
const DEFAULT_STORAGE_ADAPTER = 'json';
const STORAGE_ADAPTERS = ['json', 'milvus'];
