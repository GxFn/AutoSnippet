/**
 * Guard 违反项存储：读写 {knowledgeBase}/.autosnippet/guard-violations.json
 * 每次 // as:audit 产生一条 run，包含 filePath、triggeredAt、violations
 */
...
function getViolationsPath(projectRoot) {
	return path.join(Paths.getProjectInternalDataPath(projectRoot), VIOLATIONS_FILENAME);
}
