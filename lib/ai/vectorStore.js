 ...
 * 语义索引现统一由 lib/context 管理，存储于 Knowledge/.autosnippet/context/。
 ...
 * 存储结构: Knowledge/.autosnippet/vector_index.json
 * 格式: { version: '1.0', items: [{ id, vector, content, metadata }] }
 */
class VectorStore {
	constructor(projectRoot) {
		this.projectRoot = projectRoot;
		this.indexPath = path.join(projectRoot, 'Knowledge', '.autosnippet', 'vector_index.json');
