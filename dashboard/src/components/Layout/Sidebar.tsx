...
import { Bookmark, Copy, FolderOpen, Clock, GitBranch, Shield, MessageSquare, HelpCircle, Code, RefreshCw, Edit3, LogOut, User, ShieldCheck, Eye, Fingerprint } from 'lucide-react';
